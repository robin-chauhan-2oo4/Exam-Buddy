...
const floatingParticles = [
  { size: 4, x: '12%', y: '25%', delay: 0, duration: 7 },
  { size: 3, x: '85%', y: '18%', delay: 1.5, duration: 8.5 },
  { size: 5, x: '70%', y: '70%', delay: 0.8, duration: 6 },
  { size: 3, x: '20%', y: '85%', delay: 2.5, duration: 9 },
  { size: 4, x: '92%', y: '55%', delay: 0.3, duration: 7.5 },
];
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="mt-3">
              <BlurText
                text="Join ExamBuddy to start mastering your studies"
                delay={0.03}
                className="text-sm"
                animateBy="words"
                direction="top"
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                ...
                <div className="relative">
                  <motion.div
                    animate={{ color: focusedField === 'name' ? 'var(--accent)' : 'var(--text-muted)' }}
                  ...
                  <input
                    ...
                    style={{
                      ...
                      borderColor: focusedField === 'name' ? 'var(--accent)' : 'var(--border-color)',
                      color: 'var(--text-primary)',
                      transition: 'border-color 0.3s ease, box-shadow 0.3s ease',
                      boxShadow: focusedField === 'name' ? 'var(--input-focus-glow)' : 'none',
                    }}
                    required
                  />
                </div>
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className={`w-full flex items-center justify-center gap-2 py-3.5 px-4 text-white rounded-xl font-semibold mt-2 relative overflow-hidden ${
